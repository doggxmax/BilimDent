...
import "./tr-section-8.style.scss";
const TrSection8 = () => {
  return (
    <Fragment>
      <section className="tr-home-section-8">
        <div className="tr-home-section-8-wrap">
          {/* <h2 className="section-8-heading">How to find us?</h2> */}
          <div className="tr-home-section-8-container">
            <iframe
